...
class Magestore_Dailydeal_Block_Adminhtml_Dailydeal_Edit_Tab_Generalform extends Mage_Adminhtml_Block_Widget_Form
{
	public function __construct()
	{
		...
		$fieldset = $form->addFieldset('dailydeal_form', array('legend'=>Mage::helper('dailydeal')->__('Item information')));
