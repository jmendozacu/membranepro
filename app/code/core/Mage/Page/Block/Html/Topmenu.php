...
class Mage_Page_Block_Html_Topmenu extends Mage_Core_Block_Template
{
    ...
    public function getHtml($outermostClass = '', $childrenWrapClass = '')
    {
        ...
        if ($renderer = $this->getChild('catalog.topnav.renderer')) {
            ...
            //Zend_Debug::dump($renderer->getData()); die();
            //Zend_Debug::dump($renderer->getMenuTree()); die();
            $menuTree = $renderer->getMenuTree();
            // foreach ($menuTree as $ttt => $category) {
                // Zend_Debug::dump($ttt); die();
            // }
            // die();
        } else {
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass)
    {
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                ...
                $html .= '<ul class="test-class level' . $childLevel . '">';
