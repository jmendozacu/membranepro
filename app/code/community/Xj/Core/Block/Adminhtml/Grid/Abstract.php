 ...
 * @author Xj
 */
class Xj_Core_Block_Adminhtml_Grid_Abstract
    extends Mage_Adminhtml_Block_Widget_Grid
{
    protected $_gridId = 'xj_core_list_grid';
    ...
    /**
     * @return Xj_Core_Block_Adminhtml_Grid_Abstract
     */
    protected function _prepareCollection()
    {
        ...
        Mage::dispatchEvent($this->_eventPrefix . 'xj_grid_prepare_collection', array(
            'grid' => $this,
    ...
    protected function _prepareColumns()
    {
        ...
        Mage::dispatchEvent($this->_eventPrefix . 'xj_grid_prepare_columns', array('grid' => $this));
    ...
    protected function _prepareMassaction()
    {
        ...
        Mage::dispatchEvent($this->_eventPrefix . 'xj_grid_prepare_massaction', array('grid' => $this));
    ...
    {
        return parent::getColumn($this->_columnPrefix . $columnId);
    }
    ...
    {
        return $this->_removeColumn($this->_columnPrefix . $columnId);
    }
