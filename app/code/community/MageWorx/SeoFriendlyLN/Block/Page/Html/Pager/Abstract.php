...
if ((string) Mage::getConfig()->getModuleConfig('MageWorx_SeoBase')->active == 'true') {
    ...
    class MageWorx_SeoFriendlyLN_Block_Page_Html_Pager_Abstract extends MageWorx_SeoBase_Block_Page_Html_Pager
    {

    }

}
elseif((string) Mage::getConfig()->getModuleConfig('EcommerceTeam_Sln')->active == 'true') {
