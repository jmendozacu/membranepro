...
class MageWorx_SeoBase_Block_Adminhtml_System_Config_Frontend_Alternate_Selftest extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        if (Mage::helper('seosuite/alternate')->getAlternateScope() == 'website') {
    ...
    protected function _getSource()
    {
        ...
        foreach ($allStores as $store) {
            ...
            $alternateProductCodes = Mage::helper('seosuite/alternate')->getAlternateRawCodes('product',
                $store->getStoreId());
            ...
            $alternateCategoryCodes = Mage::helper('seosuite/alternate')->getAlternateRawCodes('category',
                $store->getStoreId());
            ...
            $alternateCmsCodes = Mage::helper('seosuite/alternate')->getAlternateRawCodes('cms', $store->getStoreId());
    ...
    protected function _markDuplicateData(&$data, $type, $websiteId, $code)
    {
        ...
        foreach ($data as $webId => $website) {
            if (Mage::helper('seosuite/alternate')->getAlternateScope() == 'website' && $webId != $websiteId) {
                continue;
            }
