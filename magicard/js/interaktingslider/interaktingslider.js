...
// Added by CyberTech START
var slideName = [];
InteraktingSlider.prototype.addSlideWithTitle = function(pCms,title){
...
InteraktingSlider.prototype.getCommande = function(){
	...
	for (i=0;i<this.countSlides();i++){
		var label = slideName[i] ? slideName[i] : (i+1);
		html += "<a href='#' id='button"+i+"' onclick='interaktingslider.goTo("+i+");return false;'><span>"+label+"</span></a>";		
	}
