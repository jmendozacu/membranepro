...
$installer->updateAttribute('order_address', 'pfpj_tip_pers', 'backend', 'customerrom/entity_address_attribute_backend_tippers');

$installer->addAttribute('order_address', 'pfpj_for_billing', array(
...
$for_billing_attribute = $installer->getAttribute($order_address_entity_type_id, 'pfpj_for_billing');
...
$installer->updateAttribute('order_address', 'pfpj_for_billing', 'default_value', $intOptionId);*/
$installer->updateAttribute('order_address', 'pfpj_for_billing', 'default_value', $installer->getTippersConfig()->getDefaultValue('pfpj_for_billing'));



$installer->addAttribute('order_address', 'pfpj_for_shipping', array(
    'type' => 'int', // same as default
    'input' => 'checkbox', // same as default
...
$for_shipping_attribute = $installer->getAttribute($order_address_entity_type_id, 'pfpj_for_shipping');
...
$installer->updateAttribute('order_address', 'pfpj_for_shipping', 'default_value', $intOptionId);*/
$installer->updateAttribute('order_address', 'pfpj_for_shipping', 'default_value', $installer->getTippersConfig()->getDefaultValue('pfpj_for_shipping'));

$installer->getConnection()->addColumn($installer->getTable('sales_flat_quote_address'), 'pfpj_for_billing', 'varchar(255) NULL');
$installer->getConnection()->addColumn($installer->getTable('sales_flat_quote_address'), 'pfpj_for_shipping', 'varchar(255) NULL');
