...
/**
 * Customer address for_billing field renderer for admin
 *
 * @author     Daniel Ifrim
 */
class PfpjRom_AdminhtmlRom_Model_CustomerRom_Renderer_Forshipping implements Varien_Data_Form_Element_Renderer_Interface
{
