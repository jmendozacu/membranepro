...
define('UNKNOWN_FONT_SIZE', 		24); // in pixels

define('CACHE_CLEANUP_FREQ', 		100000000); // -1 disable, 1 everytime, 10 would be about 1 in 10 times this script runs (higher number decreases frequency)
...
$fonts = array();
//$fonts['kozuka'] 		= 'KozukaGothic.otf';
$fonts['kozuka'] 		= 'KozGoPr6N-Regular.otf';
//$fonts['kozuka'] 		= 'KozGoPr6N-Bold.otf';


// The font will default to the following (put your most common font here).
$fonts['default'] 		= $fonts['kozuka'];
