...
Lightbox.prototype = {
    ...
    initialize: function(params) {
        ...
        console.log(this.pageScroll[1]);
        this.pageHeight = document.viewport.getHeight();
        this.pageWidth = document.viewport.getWidth();
        this.popupImageWidth = this.options.popupImageWidth;
        //console.log(this.pageScroll[1]);
    ...
    start: function(imageLink) {
        ...
        var currentPageScroll = document.viewport.getScrollOffsets();
        console.log(currentPageScroll);
        var lightboxTop = currentPageScroll[1] + (this.pageHeight / 10);
        var lightboxLeft = this.pageScroll[0] + ((this.pageWidth / 2) - (this.popupImageWidth / 2));
