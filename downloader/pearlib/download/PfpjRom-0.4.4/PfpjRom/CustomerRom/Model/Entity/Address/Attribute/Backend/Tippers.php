...
/**
 * CustomerRom pfpj_tip_pers attribute backend
 *
 * @author     Daniel Ifrim
 */
class PfpjRom_CustomerRom_Model_Entity_Address_Attribute_Backend_Tippers extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
	/**
