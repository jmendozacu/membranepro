...
/**
 * CustomerRom pfpj_for_shipping attribute backend
 *
 * @author     Daniel Ifrim
 */
class PfpjRom_CustomerRom_Model_Entity_Address_Attribute_Backend_Forshipping extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    /**
