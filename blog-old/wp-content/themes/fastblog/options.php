	...
	<form method="post" action="options.php">
		...
		<?php
			...
			foreach (array(
				...
				tb_options_field($label, __('Matters only if you do not select another in <code>Appearance/Menus</code>.', 'fastblog'), 'radio_group', "fastblog[menu][content][{$menu}]", fastblog_get_option('menu/content/'.$menu), $menu_content_array);
			}
